...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php } ?>
            <!-- form start -->
            <form role="form" action="/admin/orders/<?php echo htmlspecialchars( $order["pk_order"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" method="post">
                <div class="box-body">
                    <div class="form-group">
                        <label for="desproduct">Status do Pedido</label>
                        <select class="form-control" name="pk_status">
                            ...
                            <option <?php if( $value1["pk_status"] === $order["pk_status"] ){ ?>selected="selected"<?php } ?> value="<?php echo htmlspecialchars( $value1["pk_status"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["sts_status"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
