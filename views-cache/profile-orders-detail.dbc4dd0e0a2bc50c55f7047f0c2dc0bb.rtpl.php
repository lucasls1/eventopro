    ...
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-9">
                ...
                <h3 id="order_review_heading" style="margin-top:30px;">Detalhes do Pedido N°<?php echo htmlspecialchars( $order["pk_order"], ENT_COMPAT, 'UTF-8', FALSE ); ?></h3>
                    ...
                    <table class="shop_table">
                        ...
                        <tbody>
                            ...
                            <tr class="cart_item">
                                ...
                                <td class="product-total">
                                    <span class="amount">R$<?php echo htmlspecialchars( $value1["vlr_total"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
                                </td>
                            </tr>
                            <?php } ?>
                        ...
                        <tfoot>
                            ...
                            <tr class="order-total">
                                ...
                                <td><strong><span class="amount">R$<?php echo htmlspecialchars( $carrinho["vltotal"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span></strong> </td>
                            </tr>
                        </tfoot>
                    </table>
                    <div id="payment">
