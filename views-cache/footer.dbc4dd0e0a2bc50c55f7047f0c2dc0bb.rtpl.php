            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Evento Pro</h2>
                        <p>Evento Pro sua loja virtual para compra de ingressos de diversos tipos.</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        ...
                        <ul>
                            <?php require $this->checkTemplate("categoryes-menu");?>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        <h2 class="footer-wid-title">Fique Informado</h2>
                        <p>Receba em seu E-mail novidades sobre eventos.</p>
