            ...
            <div class="col-md-6">
                ...
                <form id="register-form-wrap" action="/register" class="register" method="post">
                    ...
                    <p class="form-row form-row-first">
                        ...
                        <input type="text" id="nome" name="nme_pessoa" class="input-text" value="">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="email">E-mail <span class="required">*</span>
                        </label>
                        <input type="email" id="email" name="eml_email" class="input-text" value="">
                    </p>
                    <p class="form-row form-row-first">
                        <label for="phone">Telefone
                        </label>
                        <input type="text" id="phone" name="nrphone" class="input-text" value="">
                    </p>
                    <p class="form-row form-row-last">
                        <label for="senha">Senha <span class="required">*</span>
                        </label>
                        <input type="password" id="senhar" name="pwd_senha" class="input-text">
                    </p>
                    <div class="clear"></div>
