                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="/admin"><i class="fa fa-lock"></i> Acesso Administrativo</a></li>
                        </ul>
                    </div>
                </div>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="/res/site/img/logoEventoPro.png"></a></h1>
                    </div>
                </div>
